...
public class ZombieEightEntity extends EntityZombie {
    ...
    public ZombieEightEntity(World world) {
        ...
        if (!AllEntityConfig.enableZombieConfig) {
            ...
            config = ConfigZombieManager.getZombieConfig("ZombieEight");
        ...
        this.texture = TexturesZombie.TEXTURES_ZOMBIE_EIGHT;
