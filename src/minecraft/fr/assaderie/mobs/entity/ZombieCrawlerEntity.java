...
public class ZombieCrawlerEntity extends EntityZombie {

    private ZombieConfig config;
    private static ForgeChunkManager.Ticket chunkTicket;

    public ZombieCrawlerEntity(World world) {
        super(world);
        ...
        if (!AllEntityConfig.enableZombieConfig) {
            ...
            config = ConfigZombieManager.getZombieConfig("Crawler");
        ...
        this.texture = TexturesZombie.TEXTURE_CRAWLER;
