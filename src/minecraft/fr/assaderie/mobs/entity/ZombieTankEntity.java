...
public class ZombieTankEntity extends EntityZombie {
    ...
    public ZombieTankEntity(World world) {
        ...
        if (!AllEntityConfig.enableZombieConfig) {
            ...
            config = ConfigZombieManager.getZombieConfig("ZombieTank");
        ...
        this.texture = TexturesZombie.TEXTURE_ZOMBIE_TANK;
