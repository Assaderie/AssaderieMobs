...
public class ZombieFiveEntity extends EntityZombie {

    private ZombieConfig config;
    private static ForgeChunkManager.Ticket chunkTicket;

    public ZombieFiveEntity(World world) {
        super(world);
        ...
        if (!AllEntityConfig.enableZombieConfig) {
            ...
            config = ConfigZombieManager.getZombieConfig("ZombieFive");
        ...
        this.texture = TexturesZombie.TEXTURE_ZOMBIE_FIVE;
