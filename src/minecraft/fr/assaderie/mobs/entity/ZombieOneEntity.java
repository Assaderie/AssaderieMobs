...
public class ZombieOneEntity extends EntityZombie {
    ...
    public ZombieOneEntity(World world) {
        ...
        if (!AllEntityConfig.enableZombieConfig) {
            ...
            config = ConfigZombieManager.getZombieConfig("ZombieOne");
        ...
        this.texture = TexturesZombie.TEXTURE_ZOMBIE_ONE;
