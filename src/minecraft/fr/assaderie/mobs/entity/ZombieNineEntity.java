...
public class ZombieNineEntity extends EntityZombie {
    ...
    public ZombieNineEntity(World world) {
        ...
        if (!AllEntityConfig.enableZombieConfig) {
            ...
            config = ConfigZombieManager.getZombieConfig("ZombieNine");
        ...
        this.texture = TexturesZombie.TEXTURES_ZOMBIE_NINE;
