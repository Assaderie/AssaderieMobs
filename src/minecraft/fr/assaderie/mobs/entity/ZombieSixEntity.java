...
public class ZombieSixEntity extends EntityZombie {

    private ZombieConfig config;
    private static ForgeChunkManager.Ticket chunkTicket;

    public ZombieSixEntity(World world) {
        super(world);
        ...
        if (!AllEntityConfig.enableZombieConfig) {
            ...
            config = ConfigZombieManager.getZombieConfig("ZombieSix");
        ...
        this.texture = TexturesZombie.TEXTURE_ZOMBIE_SIX;
