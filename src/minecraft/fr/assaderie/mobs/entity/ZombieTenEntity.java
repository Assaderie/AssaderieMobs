...
public class ZombieTenEntity extends EntityZombie {
    ...
    public ZombieTenEntity(World world) {
        ...
        if (!AllEntityConfig.enableZombieConfig) {
            ...
            config = ConfigZombieManager.getZombieConfig("ZombieTen");
        ...
        this.texture = TexturesZombie.TEXTURES_ZOMBIE_TEN;
