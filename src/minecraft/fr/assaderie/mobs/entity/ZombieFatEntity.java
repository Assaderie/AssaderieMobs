...
public class ZombieFatEntity extends EntityZombie {
    ...
    public ZombieFatEntity(World world) {
        ...
        if (!AllEntityConfig.enableZombieConfig) {
            ...
            config = ConfigZombieManager.getZombieConfig("ZombieFat");
        ...
        this.texture = TexturesZombie.TEXTURE_ZOMBIE_FAT;
