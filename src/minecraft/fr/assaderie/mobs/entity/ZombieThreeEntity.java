...
public class ZombieThreeEntity extends EntityZombie {

    private ZombieConfig config;
    private static ForgeChunkManager.Ticket chunkTicket;

    public ZombieThreeEntity(World world) {
        super(world);
        ...
        if (!AllEntityConfig.enableZombieConfig) {
            ...
            config = ConfigZombieManager.getZombieConfig("ZombieThree");
        ...
        this.texture = TexturesZombie.TEXTURE_ZOMBIE_THREE;
