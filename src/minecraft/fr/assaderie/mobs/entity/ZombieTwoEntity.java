...
public class ZombieTwoEntity extends EntityZombie {

    private ZombieConfig config;

    public ZombieTwoEntity(World world) {
        super(world);
        ...
        if (!AllEntityConfig.enableZombieConfig) {
            ...
            config = ConfigZombieManager.getZombieConfig("ZombieTwo");
        ...
        this.texture = TexturesZombie.TEXTURE_ZOMBIE_TWO;
